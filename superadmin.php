...
<body>
    ...
    <div class="container">
            ...
            <?php
                include('db.php'); 
                    ...
                    while ($ligne = mysqli_fetch_assoc($resultat)) {
                        ...
                        echo "<form method='POST'action='modifier_livre_admin.php' style='display:inline;'>"; 
                        echo "<input type='hidden' name='id_livre' value='".$ligne['id_livre']."'>";
                        echo "<button type='submit' style='color: white; background-color: #007bff; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>Modifier</button>";
                        echo "</form>";
                        echo "<form method='POST' style='display:inline;'>"; 
                        echo "<input type='hidden' name='id_livre' value='".$ligne['id_livre']."'>";
                        echo "<button type='submit' name='supprimer' style='color: white; background-color: #dc3545; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>Supprimer</button>";
                        echo "</form>";
                        echo "</div>";
                        echo "</div>";
                    }
        ...
        <section id="addadmin" class="section">
            ...
            <?php
                    if (isset($_POST['supprimer']) && isset($_POST['id_administrateur'])) {
